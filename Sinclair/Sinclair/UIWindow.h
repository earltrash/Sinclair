...
public:
	...
	bool IsInCloseButton(Vec2 pos) 
	{
		// 오른쪽에서 47 떨어진 지점이 기준이라.
		float rightMargin = (GetType() == UIWindowType::InventoryWindow) ? 86.0f : 65.0f;
		...
		float closeButtonWidth = 35.0f;
		float closeButtonHeight = 35.0f;
